...
echo "-------------"
eval "sqlite3 db.sq3 'SELECT Planet FROM planets WHERE rowid = $SOLD_COUNT;'"
eval "sqlite3 db.sq3 'SELECT Timestamp FROM planets WHERE rowid = $SOLD_COUNT;'"
eval "sqlite3 db.sq3 'SELECT Email FROM planets WHERE rowid = $SOLD_COUNT;'"
echo
